...
const h264_sps_parser_1 = require("h264-sps-parser");
...
function parse(nalu, spss) {
    if ((nalu[0] & 0x1F) !== 8)
        throw new Error("Not a PPS unit");
    const stream = new h264_sps_parser_1.Bitstream(new DataView(nalu.buffer, nalu.byteOffset + 1));
